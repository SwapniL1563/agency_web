  ...
  return (
    <div className='mt-0 md:mt-8 py-4 flex justify-center'>
      <div className='w-10/12 md:w-3/4 py-4 flex flex-col gap-4 justify-center'>
        ...
        <p className='text-sm md:text-base md:w-2/3 secondary'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-white gap-2 mt-6'>
          ...
          <div className='flex flex-col items-center glass py-10 md:py-14 px-2 md:px-5 text-center hover:bg-[#d5d5d533] cursor-pointer rounded-lg'>
            ...
            <h2 className='text-xl md:text-2xl font-semibold mb-2'>Web Design & Development</h2>
          ...
          <div className='flex flex-col items-center glass py-10 md:py-14 px-2 md:px-5 text-center hover:bg-[#d5d5d533] cursor-pointer rounded-lg'>
            ...
            <h2 className='text-xl md:text-2xl  font-semibold mb-2'>E-commerce Solutions</h2>
            <p className='text-xs md:text-sm w-[90%] md:w-5/6 text-gray-300 mt-2'>
          ...
          <div className='flex flex-col items-center glass py-10 md:py-14 px-2 md:px-5 text-center hover:bg-[#d5d5d533] cursor-pointer rounded-lg'>
            ...
            <h2 className='text-xl md:text-2xl  font-semibold mb-2'>Website Optimization</h2>
            <p className='text-xs md:text-sm w-[90%] md:w-5/6 text-gray-300 mt-2'>
          ...
          <div className='flex flex-col items-center glass py-10 md:py-14 px-2 md:px-5 text-center hover:bg-[#d5d5d533] cursor-pointer rounded-lg'>
            ...
            <h2 className='text-xl md:text-2xl  font-semibold mb-2'>Maintenance & Support</h2>
            <p className='text-xs md:text-sm w-[90%] md:w-5/6 text-gray-300 mt-2'>
